@extends('layouts.admin.app', ['body_class' => '', 'title' => 'Add Hospital'])
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.hospital.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="row">
                <div class="col-12 col-md-12 col-xl-8 col-left">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @livewire('seo-url', ['model' => 'App\\Models\\Pages\\Hospital'])
