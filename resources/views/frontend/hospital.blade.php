            ...
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    @foreach ($hospitals as $hospital)
                        <div class="col-12 col-lg-4 block-padding  pb-3 pb-lg-0 pt-lg-4 new-row"
                            style="position: relative; padding-right: 10px; padding-left: 10px; background-color: #FAF39F !important; background-image: linear-gradient(#faf39f, #fffcda); padding-bottom: 10px">
                            <a href="coming-soon">
