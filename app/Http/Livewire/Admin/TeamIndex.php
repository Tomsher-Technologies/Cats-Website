...
final class TeamIndex extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\Pages\Team>|null
     */
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', function (Team $model) {
